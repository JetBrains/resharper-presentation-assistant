...
Presentation Assistant is an extension for ReSharper 9.0 and 9.1 that will display the keyboard shortcuts for the currently executing action. Useful for demos, but also handy for pair programming - easily answer those "how did you do that?" questions.
